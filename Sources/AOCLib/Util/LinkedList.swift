...
public struct LinkedListIndex<TI>: Comparable {
    fileprivate let node: LinkedList<TI>.LinkedListNode<TI>?
    fileprivate let tag: Int
    
    public static func==<TIC>(lhs: LinkedListIndex<TIC>, rhs: LinkedListIndex<TIC>) -> Bool {
